  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gradient-to-r from-[#0a2540] via-[#000f22] to-[#006a62] p-6 md:p-8 rounded-2xl text-white shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 relative z-10 w-full md:w-auto pt-2 md:pt-0">
          <button
            onClick={() => setShowTransferModal(true)}
            className="flex-1 sm:flex-initial px-4 sm:px-5 py-2.5 bg-[#00d1c1] hover:bg-[#00b0a3] text-[#00201d] font-bold text-xs sm:text-sm rounded-xl shadow-md transition-all active:scale-95 flex items-center justify-center gap-2"
          >
          ...
          <Link
            href="/savings"
            className="flex-1 sm:flex-initial px-4 sm:px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white font-bold text-xs sm:text-sm rounded-xl border border-white/20 transition-all active:scale-95 flex items-center justify-center gap-2"
          >
